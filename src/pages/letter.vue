        ...
        <div class="main">
            <div v-show="tabIndex == 0">
                <div class="notice-item" v-for="(item, index) in mailToList" :key="index" @click="check(index, 1, item)">
                    ...
                    <span class="datetime">{{iosDate(item.createTime, "yyyy-MM-dd hh:mm:ss")}} &nbsp;&nbsp;发件人：{{item.createrCname}}</span>
            ...
            <div v-show="tabIndex == 1">
                <div class="notice-item" v-for="(item, index) in mailList" :key="index" @click="check(index, 2)">
                    ...
                    <span class="datetime">{{iosDate(item.createTime, "yyyy-MM-dd hh:mm:ss")}} &nbsp;&nbsp;收件人：{{item.receivers}}</span>
