            ...
            <swiper v-model="tabIndex" :show-dots="false" height="100%" @on-index-change="getInfoByindex">
                ...
                <swiper-item class="tab-item3">
                    <div class="scroll-box">
                        ...
                        <p v-if="!otherContacts.length" style="line-height: 50px; text-align: center;">暂无其他联系人</p>
                    </div>
                </swiper-item>
                <swiper-item class="tab-item4">
                    <div class="scroll-box">
                        ...
                        <p v-if="!relationShipList.length" style="line-height: 50px; text-align: center;">暂无相关联系人</p>
                    </div>
                    <div class="handle">
